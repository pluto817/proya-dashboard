...
function AudienceComposition() {
  const data = [
    { type: '敏感型', percentage: 37.3, color: 'bg-rose-500', count: 7530 },
    { type: '自然转化型', percentage: 62.7, color: 'bg-emerald-500', count: 12679 },
    { type: '反作用型', percentage: 0, color: 'bg-amber-500', count: 0 },
    { type: '沉睡型', percentage: 0, color: 'bg-gray-400', count: 0 }
  ];
    ...
    <div className="space-y-3">
      {data.map(item => (
        <div key={item.type} className="flex items-center gap-3">
          ...
          <div className="w-16 text-right text-xs text-gray-400">{item.count.toLocaleString()}人</div>
        </div>
      ))}
    </div>
  );
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">¥{params.orderProfit}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">¥{params.couponCost}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">¥{params.avgOrderValue}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{params.netMargin}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-rose-50 rounded-xl">
              ...
              <h4 className="font-semibold text-gray-800 mb-2">核心预算分配</h4>
            ...
            <div className="p-4 bg-purple-50 rounded-xl">
              ...
              <h4 className="font-semibold text-gray-800 mb-2">动态规模调整</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-4 bg-amber-50 rounded-xl">
              ...
              <h4 className="font-semibold text-gray-800 mb-2">黑名单机制</h4>
              <p className="text-sm text-gray-600">
      ...
      <Card className="bg-gradient-to-r from-rose-50 to-purple-50 border-rose-200">
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">核心结论</h4>
              <p className="text-gray-700">
                基于Uplift模型的最优投放策略较传统随机投放实现了<span className="font-bold text-rose-600">76.2%</span>的净收益提升，
